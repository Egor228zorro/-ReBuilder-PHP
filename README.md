...
Эти настройки можно переопределить через переменные окружения или файлы конфигурации для различных окружений (Development, Local, Production).
